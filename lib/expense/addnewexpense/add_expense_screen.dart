...
import 'package:personal_expenses/expense/addnewexpense/add_expense_screen_model.dart';
...
class AddExpenseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AddExpenseScreenModel>.reactive(viewModelBuilder: () => AddExpenseScreenModel(), builder: (context,model,child){
      return Scaffold(
                  ...
                  children: [
                    ...
                    GestureDetector(
                      ...
                      child: Container(
                        ...
                        child: model.result != null ? Image.file(model.result!,fit: BoxFit.cover,) :const Center(
                          child: Icon(IconRes.add,color: ColorRes.white,),
                        ),
                      ),
                    ),
