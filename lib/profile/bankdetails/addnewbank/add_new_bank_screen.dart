...
import 'package:personal_expenses/profile/bankdetails/addnewbank/add_new_bank_screen_model.dart';
...
class AddNewBankScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AddNewBankModel>.reactive(
      viewModelBuilder: () => AddNewBankModel(), builder: (context,model,child){
      return Scaffold(
                ...
                children: [
                  ...
                  Align(
                    ...
                    child: Container(
                        ...
                        child: Text(StringRes.newbankdetails,style: appTextStyle(textColor: ColorRes.headingColor,fontWeight: FontWeight.w500,fontSize: 22.0),)),
                  ),
