...
import 'package:personal_expenses/history/history_screen_model.dart';
...
class HistoryScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<HistoryScreenModel>.reactive(viewModelBuilder: () => HistoryScreenModel(), builder: (context,model,child){
      return WillPopScope(
        onWillPop: ()async{
            ...
            children: [
              ...
              Expanded(
                  ...
                  builder: (BuildContext context,AsyncSnapshot<List<TransactionTable>> snapshot){
                    if(snapshot.hasData){
                      if(snapshot.data!.length > 0){
                        ...
                        //model.find = newMap.values.toList();

                        print('listvalue------------${model.listvalue}');
                ...
                model.find.isNotEmpty
                    ?
                /*ListView.builder(
              itemCount: model.find.first.length,
                itemBuilder: (context,index){
                  //var newlist = model.find.first;
                        ...
                        child: Center(
                          child: ListView.builder(
                            ...
                            itemBuilder: (context, int i){
                              ...
                              DateTime d = DateTime.parse(newlist[i][index]['date']);
                              final now = DateTime.now();
                                      ...
                                      Row(
                                        children: [
                                          Container(
                                            ...
                                            child: Image.memory(newlist[i][index]['logo'],fit: BoxFit.scaleDown,),
                                          ),
                                          ...
                                          Expanded(
                                            child: Column(
                                              ...
                                              crossAxisAlignment: CrossAxisAlignment.start,
                                              children: [
                                                Text(newlist[i][index]['title'].toString(),style: appTextStyle(fontSize: 21.0,textColor: ColorRes.headingColor,fontWeight: FontWeight.w500),),
                                                Text(newlist[i][index]['subtitle'].toString(),style: appTextStyle(fontSize: 12.0,textColor: ColorRes.textHintColor),),
                                              ],
                                            ),
                                          ),
                                          ...
                                          Container(
                                            ...
                                            child: Column(
                                              ...
                                              crossAxisAlignment: CrossAxisAlignment.end,
                                              children: [
                                                Text('\u{20B9} ${newlist[i][index]['price'].toStringAsFixed(1)} /-',style: appTextStyle(fontSize: 21.0,textColor: newlist[i].first['type'] == StringRes.expense ? Colors.red :Colors.green,fontWeight: FontWeight.w500),),
                                                SizedBox(height: Get.height*.005,),
                                                Text('$d2 $d3',style: appTextStyle(fontSize: 14.0,textColor: ColorRes.textHintColor),),
                                              ],
                                            ),
