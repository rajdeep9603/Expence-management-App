...
import 'package:personal_expenses/group/groupsetting/editgroup/edit_group_screen_model.dart';
...
class EditGroupScreen extends StatelessWidget {
  ...
  GetSingalGroupContact g;

  EditGroupScreen({required this.g});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<EditGroupScreenModel>.reactive(
      onModelReady: (model){
        model.init(g);
      },
      viewModelBuilder: () => EditGroupScreenModel(), builder: (context,model,child){
      return Scaffold(
                            ...
                            Container(
                              ...
                              decoration: BoxDecoration(
                                ...
                                image: model.result != null ? DecorationImage(
                                  ...
                                  fit: BoxFit.cover,
                                ) : DecorationImage(image: NetworkImage(model.img),fit: BoxFit.cover),
                              ),
                            ),
                      ...
                      child: Align(
                        ...
                        child: Container(
                          ...
                          child: DottedBorder(
                            ...
                            child: Center(
                              child: Align(alignment: Alignment.center,child: Text(model.bresult != null ? 'Photo changed successfully' : 'Change your cover photo',style: appTextStyle(textColor: ColorRes.textHintColor,fontSize: 14.0),)),
                            ),
                          ),
                        ),
                      ),
