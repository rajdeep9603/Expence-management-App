...
import 'package:personal_expenses/receive/addreceive/add_new_receive_screen_model.dart';
...
class AddNewReceiveScreen extends StatelessWidget {
  const AddNewReceiveScreen({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<AddNewReceiveScreenModel>.reactive(viewModelBuilder: () => AddNewReceiveScreenModel(), builder: (context,model,child){
      return Scaffold(
