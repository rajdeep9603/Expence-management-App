...
import 'package:personal_expenses/receive/updatereceive/update_receive_screen_model.dart';
...
class UpdateReceiveScreen extends StatelessWidget {
  int id;

  UpdateReceiveScreen({required this.id});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<UpdateReceiveScreenModel>.reactive(
      onModelReady: (model){
        model.init(id);
      },
      viewModelBuilder: () => UpdateReceiveScreenModel(), builder: (context,model,child){
      return Scaffold(
