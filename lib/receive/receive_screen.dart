...
import 'package:personal_expenses/receive/addreceive/add_new_receive_screen.dart';
import 'package:personal_expenses/receive/receive_screen_model.dart';
import 'package:personal_expenses/receive/updatereceive/update_receive_screen.dart';
...
class ReceiveScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<ReceiveScreenModel>.reactive(viewModelBuilder: () => ReceiveScreenModel(), builder: (context,model,child){
      return Scaffold(
        ...
        body: Column(
          children: [
              ...
              children: [
                ...
                GestureDetector(
                  onTap: (){
                    ...
                    Get.to(() => const AddNewReceiveScreen());
            ...
            Expanded(
              child: FutureBuilder(
                future: DatabaseHelper.internal().receives(),
                builder: (BuildContext context, AsyncSnapshot<List<RecieveTable>> snapshot){
                  if(snapshot.hasData){
                                      ...
                                      children: [
                                        ...
                                        GestureDetector(
                                          onTap: (){
                                            ...
                                            Get.to(() => UpdateReceiveScreen(id: snapshot.data![index].id!));
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text('\u{20B9} ${snapshot.data![index].ramount!.toStringAsFixed(2)}',style: appTextStyle(textColor: ColorRes.headingColor,fontSize: 20.0,fontWeight: FontWeight.w500),),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        SizedBox(height: Get.width*.01,),
                                        Text('${snapshot.data![index].rinterest!.toStringAsFixed(2)}%',style: appTextStyle(textColor: ColorRes.headingColor,fontSize: 20.0,fontWeight: FontWeight.w500),),
                                        Divider(height: Get.height*.01,),
                                      ],
                                    ),
                                  ),
