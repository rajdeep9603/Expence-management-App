...
import 'package:personal_expenses/income/addnewincome/add_income_screen.dart';
import 'package:personal_expenses/income/income_screen_model.dart';
...
class IncomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<IncomeScreenModel>.reactive(viewModelBuilder: () => IncomeScreenModel(), builder: (context,model,child){
      return WillPopScope(
        onWillPop: ()async{
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  ...
                  if (model.showsearchbar == true) Expanded(
                  ...
                  builder: (BuildContext context,AsyncSnapshot<List<TransactionTable>> snapshot){
                    if(snapshot.hasData){
                      ...
                      snapshot.data!.forEach((element) {
                          if(element.ttype! == StringRes.income){
                      ...
                      if(model.items!.length > 0){
                        ...
                        print('---keys --------${model.listkeys}');
                        print('---value --------${model.listvalue}');
                        print('---map --------$newMap');
                        ...
                        /*return ListView.builder(
                          ...
                          itemBuilder: (context, int index){
                            ...
                            print(model.items![index].ttype);

                            DateTime d = DateTime.parse(model.items![index].date!);
                              ...
                              child: Row(
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Image.memory(model.items![index].logo!,fit: BoxFit.scaleDown,),
                                  ),
                                  ...
                                  Expanded(
                                    child: Column(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        Text(model.items![index].ttitle!,style: appTextStyle(fontSize: 21.0,textColor: ColorRes.headingColor,fontWeight: FontWeight.w500),),
                                        Text(model.items![index].subtitle!,style: appTextStyle(fontSize: 12.0,textColor: ColorRes.textHintColor),),
                                      ],
                                    ),
                                  ),
                                  ...
                                  Container(
                                    ...
                                    child: Column(
                                      ...
                                      crossAxisAlignment: CrossAxisAlignment.end,
                                      children: [
                                        Text('\u{20B9} ${model.items![index].price!.toStringAsFixed(1)} /-',style: appTextStyle(fontSize: 21.0,textColor: Colors.green,fontWeight: FontWeight.w500),),
