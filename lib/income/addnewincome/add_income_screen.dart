...
import 'package:personal_expenses/income/addnewincome/add_income_screen_model.dart';
...
class AddIncomeScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder<AddIncomeScreenModel>.reactive(viewModelBuilder: () => AddIncomeScreenModel(), builder: (context,model,child){
      return Scaffold(
            ...
            children: [
              ...
              Row(children: [
                ...
                Container(
                    ...
                    child: Text(StringRes.addIncome,style: appTextStyle(fontSize: 22.0,fontWeight: FontWeight.w400,textColor: ColorRes.headingColor),)),
