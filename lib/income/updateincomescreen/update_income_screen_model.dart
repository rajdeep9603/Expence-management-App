...
class UpdateIncomeScreenModel extends BaseViewModel{
  ...
  submit() async{
    ...
    if(result != null && categoryContoller.text.isNotEmpty && titleContoller.text.isNotEmpty && discriptionContoller.text.isNotEmpty && amountContoller.text.isNotEmpty && dateContoller.text.isNotEmpty){
      ...
      TransactionTable tt = TransactionTable(id: idauto,tcatagory: categoryContoller.text,entrydate: d1, ttypeid: 1,date: dateContoller.text,subtitle: discriptionContoller.text,logo: result,price: double.parse(amountContoller.text),ttitle: titleContoller.text,ttype: StringRes.income);
