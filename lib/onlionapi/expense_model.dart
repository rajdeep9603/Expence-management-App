...
//
//     final singalExpenseAdd = singalExpenseAddFromJson(jsonString);

import 'dart:convert';

SingalExpenseAdd singalExpenseAddFromJson(String str) => SingalExpenseAdd.fromJson(json.decode(str));

String singalExpenseAddToJson(SingalExpenseAdd data) => json.encode(data.toJson());

class SingalExpenseAdd {
  SingalExpenseAdd({
    this.message,
    this.messageCode,
    this.status,
  ...
  factory SingalExpenseAdd.fromJson(Map<String, dynamic> json) => SingalExpenseAdd(
