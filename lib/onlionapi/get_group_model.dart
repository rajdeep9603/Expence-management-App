...
//
//     final getAllGroup = getAllGroupFromJson(jsonString);

import 'dart:convert';

GetAllGroup getAllGroupFromJson(String str) => GetAllGroup.fromJson(json.decode(str));

String getAllGroupToJson(GetAllGroup data) => json.encode(data.toJson());
...
class GetAllGroup {
  ...
  factory GetAllGroup.fromJson(Map<String, dynamic> json) => GetAllGroup(
...
class Data {
  ...
  factory Data.fromJson(Map<String, dynamic> json) => Data(
    ...
    ecList: json["ecList"] == null ? null : List<dynamic>.from(json["ecList"].map((x) => x)),
  );

  Map<String, dynamic> toJson() => {
    "eg": eg,
    "gdList": gdList == null ? null : List<dynamic>.from(gdList!.map((x) => x.toJson())),
    "ecList": ecList == null ? null : List<dynamic>.from(ecList!.map((x) => x)),
  };
}
