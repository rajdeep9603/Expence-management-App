...
//
//     final isContactSelected = isContactSelectedFromJson(jsonString);

import 'dart:convert';

IsContactSelected isContactSelectedFromJson(String str) => IsContactSelected.fromJson(json.decode(str));

String isContactSelectedToJson(IsContactSelected data) => json.encode(data.toJson());

class IsContactSelected {
  IsContactSelected({
    this.message,
    this.messageCode,
    this.status,
  ...
  factory IsContactSelected.fromJson(Map<String, dynamic> json) => IsContactSelected(
