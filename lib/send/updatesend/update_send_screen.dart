...
import 'package:personal_expenses/send/updatesend/update_send_screen_model.dart';
...
class UpdateSendScreen extends StatelessWidget {
  int id;

  UpdateSendScreen({required this.id});

  @override
  Widget build(BuildContext context) {
    return ViewModelBuilder<UpdateSendScreenModel>.reactive(
      onModelReady: (model){
        model.init(id);
      },
      viewModelBuilder: ()=>UpdateSendScreenModel(), builder: (context,model,child){
      return Scaffold(
